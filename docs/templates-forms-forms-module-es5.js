...
var CreateComponent = /** @class */ (function () {
    function CreateComponent(activatedRout) {
    ...
    CreateComponent.prototype.numberCheckValidation = function (e) {
    ...
    CreateComponent.prototype.checkHiddenId = function () {
        if (history.state.id) {
    ...
    CreateComponent.prototype.checkQueryParams = function () {
        var _this = this;
        this.activatedRout.queryParams.subscribe(function (queryParams) {
            if (queryParams.updateMode) {
                _this.updateMode = queryParams.updateMode;
                _this.userId = +queryParams.id;
                _this.submitButtonTittle = 'Edit';
                _this.displayUserData();
            }
        });
    };
    CreateComponent.prototype.displayUserData = function () {
        var e_1, _a;
        if (this.updateMode) {
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.editUserDataArray), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var user = _c.value;
    ...
    CreateComponent.prototype.ViewChildFun = function (data) {
...
var routes = [{ path: 'create', component: _create_create_component__WEBPACK_IMPORTED_MODULE_4__["CreateComponent"] }];
...
var FormsComponentModule = /** @class */ (function () {
    function FormsComponentModule() {
    }
...
//# sourceMappingURL=templates-forms-forms-module-es5.js.map